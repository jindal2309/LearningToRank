...
ranker = LambdaRankNN(input_size=train_X.shape[1], hidden_layer_sizes=(8,4,), activation=('relu', 'relu',), solver='adam')
...
df.to_csv("lambda_rank_hidden_size_8_4.csv", index = False)
